...
#+begin_src emacs-lisp :tangle babel-config.el      
...
#+begin_src emacs-lisp :tangle "basic-configs.el"
;; Looks
...
#+begin_src emacs-lisp :tangle "evil-config.el"
(require 'package)
(add-to-list 'package-archives '("melpa" . "http://melpa.org/packages/") t)
(add-to-list 'package-archives '("org"   . "http://orgmode.org/elpa/") t)
(add-to-list 'package-archives '("gnu"   . "http://elpa.gnu.org/packages/") t)
...
(use-package evil
  ...
  (blink-cursor-mode 0))
#+end_src
#+begin_src emacs-lisp :tangle "fast-notes.el"
...
#+end_src
#+begin_src emacs-lisp :tangle "org-agenda-addons.el"
...
#+end_src
#+begin_src emacs-lisp :tangle "org-agenda-config.el"
